...
var _slcsampletable = _interopRequireDefault(require("./slcsampletable"));

var _slclayer = _interopRequireDefault(require("./slclayer"));

var _slcboundary = require("./slcboundary");
...
class SlcModel {
  ...
  loadFromArray(arr) {
    ...
    this.box();
    this.sliceNums = this.layers.length; // console.log(this);
  ...
  _readTable(arr) {
    ...
    for (let i = 0; i < size; i++) {
      ...
      let sampleTable = new _slcsampletable.default(zmin, thickness, linewidth);
  ...
  _readData(arr) {
    while (true) {
      ...
      let boundaryNums = this._readInteger(arr); // console.log(zlayer,boundaryNums);
      ...
      if (boundaryNums == 0xFFFFFFFF) {
        ...
        let layer = new _slclayer.default(zlayer, boundaryNums); // console.log(layer);
  ...
  _readBoundary(arr) {
    ...
    let boundary = new _slcboundary.SlcBoundary(nums, gaps);
    ...
    for (let i = 0; i < nums; i++) {
      ...
      let vertex = new _slcboundary.SlcVertex(x, y);
